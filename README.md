...
- mkref
  ...
  - --dryrun : Do not execute anything, and display what would be done. If you have a very large workflow,<br>use --dryrun --quiet to just print a summary of the DAG of jobs.
...
DynamicST count --sample sampleName --id sampleName --inputdir rawdata/ --gtf Homo_sapiens.GRCh38.99.gtf 
--transcriptome Homo_sapiens_GRCh38  --image HE.tif  --alignment alignment.json --outputdir result
```
